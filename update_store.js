      ...
      <div className="lg:col-span-5 flex flex-col gap-5">
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-stone-200">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-ink">Market & Grain</h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <input type="number" step="0.01" value={currentPrice} onChange={(e) => setCurrentPrice(e.target.value)} className="w-full px-4 py-3 bg-stone-50 border border-stone-300 rounded-xl focus:ring-2 focus:ring-silo-steel outline-none text-base font-medium" />
            </div>
          </div>
          
          <div className="mb-4">
            <label className="block text-sm font-semibold text-stone-800 mb-1">Quantity Stored (bu)</label>
            <input type="number" value={quantity} onChange={(e) => setQuantity(e.target.value)} className="w-full px-4 py-3 bg-stone-50 border border-stone-300 rounded-xl focus:ring-2 focus:ring-silo-steel outline-none text-base font-medium" />
          </div>
        </div>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-stone-200">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-ink">Storage Costs</h2>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input type="number" value={annualFixedCost} onChange={(e) => setAnnualFixedCost(e.target.value)} className="w-full px-4 py-3 bg-stone-50 border border-stone-300 rounded-xl focus:ring-2 focus:ring-silo-steel outline-none text-base font-medium" />
            </div>
            <div>
              ...
              <input type="number" value={monthlyOpCost} onChange={(e) => setMonthlyOpCost(e.target.value)} className="w-full px-4 py-3 bg-stone-50 border border-stone-300 rounded-xl focus:ring-2 focus:ring-silo-steel outline-none text-base font-medium" />
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <input type="number" step="0.1" value={interestRate} onChange={(e) => setInterestRate(e.target.value)} className="w-full px-4 py-3 bg-stone-50 border border-stone-300 rounded-xl focus:ring-2 focus:ring-silo-steel outline-none text-base font-medium" />
          </div>
        </div>
        ...
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-stone-200">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-ink">Duration & Outlook</h2>
          </div>
          ...
          <div>
            ...
            <input type="number" step="0.01" value={expectedFuturePrice} onChange={(e) => setExpectedFuturePrice(e.target.value)} placeholder="e.g. 5.20" className="w-full px-4 py-3 bg-stone-50 border border-stone-300 rounded-xl focus:ring-2 focus:ring-silo-steel outline-none text-base font-medium" />
          </div>
        </div>
      </div>
      ...
      <div className="lg:col-span-7 flex flex-col gap-6">
        <div className="bg-silo-steel rounded-2xl shadow-xl p-8 sm:p-10 text-white relative overflow-hidden flex flex-col md:flex-row gap-8 items-center justify-between">
          ...
          <div className="shrink-0 flex flex-col items-center">
             ...
             />
             <div className="mt-2 text-center text-xs font-semibold uppercase tracking-widest text-stone-400">
        ...
        {/* CTAs */}
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between p-6 bg-field-sage/5 rounded-2xl border border-field-sage/20">
          <div>
  ...
  const faq = (
    <>
      <div className="bg-white p-6 rounded-xl border border-stone-200">
        <h3 className="font-bold text-lg text-ink mb-2">Should I store my corn or sell it now?</h3>
      ...
      <div className="bg-white p-6 rounded-xl border border-stone-200">
        <h3 className="font-bold text-lg text-ink mb-2">How much does it cost to store grain on farm per month?</h3>
      ...
      <div className="bg-white p-6 rounded-xl border border-stone-200">
        <h3 className="font-bold text-lg text-ink mb-2">Why is my interest cost so high?</h3>
...
fs.writeFileSync('src/pages/tools/StoreOrSellCalculator.tsx', code);
