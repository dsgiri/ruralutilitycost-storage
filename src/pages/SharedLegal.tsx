...
export function SharedLegal({ type }: { type: 'legal' | 'license' | 'privacy' }) {
  ...
  return (
    <div className="flex-1 w-full max-w-4xl mx-auto px-4 sm:px-8 py-16 overflow-y-auto">
       <div className="bg-white border-l-4 border-blue-600 p-8 shadow-sm rounded-r-xl border-y border-r border-stone-200">
          <h1 className="text-3xl font-light text-stone-800 mb-6 flex items-center gap-3">
             {selected.title}
          </h1>
